...
Authorization: Your Clerk Auth Token
...
2. **User Email**:
   - Enter the email address exactly as they registered with Clerk
...
- Make sure the email address matches exactly how they registered with Clerk
