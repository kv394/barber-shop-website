...
const startStr = 'function CustomPageContent({ content, shop, themeColor, className, onBookClick }';
const endStr = 'export default function ClientPage';
...
`;
  ...
  console.log('Replaced CustomPageContent perfectly.');
} else {
