...
function ProfileContent() {
 ...
 <div className="bg-crm-surface border border-crm-border shadow-sm rounded-xl p-6 flex flex-col items-center justify-center space-y-4 print:bg-crm-surface print:border-none print:shadow-none print:text-crm-text">
 <h2 className="font-bold text-crm-text print:text-crm-text text-xl">My Check-in Code</h2>
