...
export default function SecurityProfilePage() {
  ...
  return (
    <div className="max-w-2xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
      <h1 className="font-bold text-crm-text mb-6 text-4xl md:text-5xl lg:text-6xl">Security & Recovery</h1>
      
      <div className="bg-crm-surface border border-crm-border shadow-sm rounded-xl p-6">
        <h2 className="font-semibold text-crm-text mb-2 text-3xl md:text-4xl">Authenticator App Recovery</h2>
        ...
        {setupState === 'scanning' && (
          <div className="space-y-6">
            ...
            <div>
              <p className="text-crm-text mb-2 text-base md:text-lg">
                1. Scan the QR code with your Authenticator App.
              </p>
              <p className="text-crm-text mb-4 text-base md:text-lg">
