...
export default function SecurityProfilePage() {
  ...
  return (
    <div className="max-w-2xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
      <h1 className="text-2xl font-bold text-white mb-6">Security & Recovery</h1>
      
      <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6">
        <h2 className="text-xl font-semibold text-white mb-2">Authenticator App Recovery</h2>
        ...
        {setupState === 'idle' && (
          <button
            ...
            disabled={loading}
            className="bg-brand-gold text-black font-semibold py-2 px-6 rounded-lg hover:bg-white transition-colors disabled:opacity-50"
          >
            ...
            <div>
              ...
              <div className="flex gap-4">
                <input
                  ...
                  className="bg-slate-900 border border-slate-600 rounded-lg px-4 py-2 text-white w-32 tracking-widest text-center"
                />
                <button
