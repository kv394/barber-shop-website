    ...
    <>
      ...
      {!isSuperAdmin && (
        <header className="sm:hidden fixed top-0 left-0 right-0 z-[100] flex justify-between items-center bg-botanical-surface border-b border-botanical-border px-4 py-3 shadow-sm">
          <div className="flex flex-col min-w-0 pr-4">
             <span className="text-botanical-text font-black text-[12px] leading-tight truncate">{data.shop.name}</span>
      ...
      <main className="flex h-[100dvh] overflow-y-auto overflow-x-hidden flex-col items-center bg-botanical-bg text-botanical-text px-0 sm:p-4 md:p-8 lg:p-12 pb-24 sm:pb-4 pt-[64px] sm:pt-4 md:pt-8 lg:pt-12 scroll-smooth">
        ...
        <header className="hidden sm:flex justify-between items-center mb-6 sm:mb-8">
          <h1 className="font-serif text-base sm:text-[12px] font-bold">
            {isSuperAdmin ? (
        ...
        {isSuperAdmin && (
            ...
            <div className="min-w-0">
                <h2 className="font-serif text-[12px] sm:text-sm md:text-base font-bold text-botanical-accent mb-1 sm:mb-2 truncate">{data.shop.name}</h2>
            </div>
            </header>
        )}
        ...
        {!isSuperAdmin && (
            ...
            <div className="min-w-0">
                <h2 className="font-serif text-[12px] sm:text-sm md:text-base font-bold text-botanical-accent mb-1 sm:mb-2 truncate">Management Dashboard</h2>
            </div>
