...
export default function ClientKiosk({ shopName, shopId, services }: { shopName: string, shopId: string, services: any[] }) {
 ...
 <button onClick={() => setMode('CHECK_IN')} className="h-48 bg-amber-500 hover:bg-amber-400 text-crm-text rounded-2xl flex flex-col items-center justify-center gap-3 transition-colors shadow-lg shadow-amber-500/20 group">
 ...
 disabled={loading}
 className="w-full py-6 bg-amber-500 hover:bg-amber-400 text-crm-text font-black text-xl rounded-2xl transition-colors shadow-lg shadow-amber-500/20 disabled:opacity-50"
 >
 ...
 disabled={loading}
 className="w-full py-6 bg-crm-surface hover:bg-gray-200 text-crm-text font-black text-xl rounded-2xl transition-colors shadow-lg shadow-white/10 disabled:opacity-50"
 >
