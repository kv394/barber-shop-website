export default function Loading() {
  return (
    <div className="animate-pulse">
      ...
      {/* Content skeleton */}
      <div className="bg-botanical-surface p-4 sm:p-8 rounded-xl border border-botanical-border shadow-sm">
        {/* Summary cards skeleton */}
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
          {Array.from({ length: 4 }).map((_, i) => (
            <div key={i} className="bg-botanical-bg/50 rounded-xl p-4 sm:p-6 border border-botanical-border shadow-sm">
        ...
        <div className="space-y-3">
          {Array.from({ length: 5 }).map((_, i) => (
            <div key={i} className="flex items-center gap-4 p-3 rounded-lg bg-botanical-bg/30 border border-botanical-border shadow-sm">
