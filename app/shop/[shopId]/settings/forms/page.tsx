...
export default async function FormsSettingsPage({ params }: { params: Promise<{ shopId: string }> }) {
  ...
  return (
    <ShopAdminLayout shopName={data.shop.name} shopSlug={data.shopSlug} pageTitle="Digital Intake Forms" shopId={shopId} userRole={data.userRole} activeTab="settings">
      <SettingsSubNav shopId={shopId} active="forms" />
