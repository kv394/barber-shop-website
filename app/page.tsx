...
function KioskMode({ userProfile }: { userProfile: UserProfile }) {
    ...
    return (
        <main className="min-h-screen flex flex-col bg-brand-dark text-white p-4 md:p-8 overflow-hidden">
...
export default function Home() {
  ...
  if (userProfile?.shopId && userProfile.role !== 'SUPER_ADMIN') {
    return <div className="flex min-h-screen items-center justify-center bg-brand-dark text-white">Redirecting to your shop portal...</div>;
  }
