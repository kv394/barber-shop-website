      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-6">
        <form onSubmit={handleSearch} className="flex-1 flex gap-2">
          <input
            ...
            className="flex-1 bg-botanical-surface border border-botanical-border rounded-lg px-4 py-2.5 text-botanical-text text-sm placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-botanical-primary"
          />
          <button
            type="submit"
                        ...
                        {editingUser === user.id ? (
                          <div className="flex gap-1 items-center">
                            <select
                              ...
                              className="bg-botanical-surface text-botanical-text text-xs rounded px-2 py-1 border border-botanical-border"
                            >
