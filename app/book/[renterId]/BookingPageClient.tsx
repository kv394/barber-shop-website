      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative z-10 px-4 pt-10 pb-8 max-w-lg mx-auto text-center">
          ...
          <div className="w-20 h-20 rounded-full mx-auto mb-4 bg-amber-500/20 border-2 border-amber-400/50 flex items-center justify-center text-3xl overflow-hidden shadow-lg shadow-amber-500/20">
            {renter.imageUrl
              ? <img src={renter.imageUrl} alt={renter.name || ''} className="w-full h-full object-cover" />
          ...
          {step === 'datetime' && selectedService && (
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full py-4 bg-amber-500 hover:bg-amber-400 text-black font-black rounded-2xl transition-colors disabled:opacity-30 disabled:cursor-not-allowed text-[15px]"
              >
                Continue →
              </button>
            </div>
          ...
          {step === 'info' && selectedService && selectedTime && (
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full py-4 bg-amber-500 hover:bg-amber-400 text-black font-black rounded-2xl transition-all disabled:opacity-40 disabled:cursor-not-allowed text-[15px] flex items-center justify-center gap-2 shadow-lg shadow-amber-500/30"
              >
                {paying ? (
