...
export default function CustomPageContent({ content, shop, themeColor, className, onBookClick, reviews = [], templateType = 'modern' }: { content: string, shop: any, themeColor?: string, className?: string, onBookClick?: (service: any) => void, reviews?: any[], templateType?: string }) {
 ...
 case 'corporate':
 return {
 card: 'bg-crm-surface rounded-lg shadow-lg border border-crm-border p-6 flex flex-col items-center text-center',
 serviceCard: 'bg-crm-surface rounded-lg shadow-lg border border-crm-border p-6 flex flex-col',
 title: 'font-bold text-crm-text mb-2 text-lg',
 price: 'text-lg font-bold text-blue-600',
 desc: 'text-crm-muted mb-4 text-[13px] flex-grow',
 ...
 btn: 'w-full bg-crm-surface text-crm-text font-bold uppercase py-3 tracking-[0.2em] hover:bg-gray-200 transition-colors',
 ...
 btn: 'font-semibold flex items-center justify-center gap-2 uppercase tracking-widest py-3 border border-[#d4af37] text-[#d4af37] hover:bg-[#d4af37] hover:text-crm-text transition-colors',
 btnStyle: themeColor ? { borderColor: themeColor, color: themeColor } : {}
 };
 case 'minimal':
 return {
 card: 'bg-transparent border border-crm-border p-6 flex flex-col items-center text-center',
 serviceCard: 'bg-transparent border-b border-crm-border pb-6 flex flex-col md:flex-row justify-between md:items-center',
 title: 'font-medium text-lg text-crm-text',
 price: 'font-medium text-crm-text',
 desc: 'text-crm-muted mt-2 text-[13px] leading-relaxed',
 ...
 default:
 return {
 card: 'bg-crm-surface rounded-2xl p-6 shadow-sm border border-crm-border flex flex-col items-center text-center',
 serviceCard: 'bg-crm-surface rounded-2xl p-6 shadow-sm border border-crm-border flex flex-col',
 title: 'font-bold text-crm-text text-lg mb-2',
 price: 'px-3 py-1 rounded-full text-[13px] font-bold inline-block mb-4',
 desc: 'text-crm-muted mb-6 text-[14px] flex-grow leading-relaxed',
