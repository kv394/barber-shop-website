...
export default function CRMDashboard() {
 ...
 return (
 <div className="flex h-screen overflow-hidden bg-crm-bg text-crm-text selection:bg-crm-primary/20">
 ...
 <input type="text" placeholder="Search" className="block w-full pl-9 pr-3 py-1.5 text-[13px] bg-crm-bg border-none rounded-lg focus:ring-1 focus:ring-crm-primary" />
 ...
 <li><a href="#" className="flex items-center gap-3 px-2 py-1.5 text-[13px] font-medium text-crm-muted hover:text-crm-text rounded-lg hover:bg-crm-bg transition-colors"><span>⏱</span> Dashboard</a></li>
 <li>
 <a href="#" className="flex items-center justify-between px-2 py-1.5 text-[13px] font-semibold text-crm-text bg-crm-bg rounded-lg">
 <div className="flex items-center gap-3">
 <UserIcon /> Leads
 </div>
 ...
 <li><a href="#" className="flex items-center gap-3 px-2 py-1.5 text-[13px] font-medium text-crm-muted hover:text-crm-text rounded-lg hover:bg-crm-bg transition-colors"><span>📦</span> Orders</a></li>
 <li><a href="#" className="flex items-center gap-3 px-2 py-1.5 text-[13px] font-medium text-crm-muted hover:text-crm-text rounded-lg hover:bg-crm-bg transition-colors"><span>👥</span> Customers</a></li>
 <li>
 <a href="#" className="flex items-center justify-between px-2 py-1.5 text-[13px] font-medium text-crm-muted hover:text-crm-text rounded-lg hover:bg-crm-bg transition-colors">
 <div className="flex items-center gap-3">
 <span>💬</span> Messages
 </div>
 ...
 <ul className="space-y-1">
 <li><a href="#" className="flex items-center gap-3 px-2 py-1.5 text-[13px] font-medium text-crm-muted hover:text-crm-text rounded-lg hover:bg-crm-bg transition-colors"><div className="w-1.5 h-1.5 rounded-full bg-crm-primary"></div> Sales</a></li>
 <li><a href="#" className="flex items-center gap-3 px-2 py-1.5 text-[13px] font-medium text-crm-muted hover:text-crm-text rounded-lg hover:bg-crm-bg transition-colors"><div className="w-1.5 h-1.5 rounded-full bg-yellow-500"></div> Account Management</a></li>
 <li><a href="#" className="flex items-center gap-3 px-2 py-1.5 text-[13px] font-medium text-crm-muted hover:text-crm-text rounded-lg hover:bg-crm-bg transition-colors"><div className="w-1.5 h-1.5 rounded-full bg-green-500"></div> Support & Success</a></li>
 </ul>
 </div>
 ...
 <input type="checkbox" className="rounded border-crm-border text-crm-primary focus:ring-crm-primary" />
 </th>
 ...
 <button className="bg-crm-surface text-crm-text px-3 py-1.5 rounded-lg text-[13px] font-semibold hover:bg-crm-surface transition-colors ml-4" onClick={() => setSelectedLeads([])}>Discard</button>
 </div>
 )}
