        ...
        <div>
          ...
          {!isSignedIn && (
            <div className="bg-crm-surface p-8 rounded-lg text-center border border-crm-border shadow-sm max-w-2xl mx-auto mt-12">
              ...
              <p className="text-crm-muted mb-8 text-[14px]">Join thousands of barbershops using BarberSaaS to streamline their operations, increase bookings, and grow their revenue.</p>
