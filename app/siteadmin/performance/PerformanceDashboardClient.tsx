              ...
              {topShops.length === 0 ? (
                ...
                topShops.map((shop, i) => (
                  <tr key={shop.id} className="hover:bg-white/40 transition-colors">
                    ...
                    <td className="p-4">
                      <span className="px-2.5 py-1 rounded-md text-[10px] font-black uppercase tracking-widest bg-crm-bg/50 border border-white/20 shadow-inner text-crm-primary">
                        {shop.tier}
                      </span>
                    </td>
