  ...
  switch (templateType) {
    case 'sporty':
      return {
        ...
        cardInactive: 'border-2 border-crm-border rounded-none wizard-card-hover',
        ...
        input: 'w-full border-2 border-crm-border p-4 rounded-none focus:outline-none font-bold wizard-input-focus',
        title: 'text-xl font-black uppercase italic'
      };
    case 'corporate':
      return {
        cardActive: 'border shadow-md rounded-lg',
        cardInactive: 'border border-crm-border hover:shadow-sm rounded-lg wizard-card-hover',
    ...
    case 'vibrant':
      return {
        ...
        cardInactive: 'border-2 border-transparent bg-crm-bg hover:bg-gray-100 rounded-2xl wizard-card-hover',
    ...
    case 'editorial':
      return {
        cardActive: 'border bg-[#fdfbf7] rounded-none',
        cardInactive: 'border border-crm-border rounded-none wizard-card-hover',
        btnPrimary: 'w-full font-semibold uppercase tracking-widest py-4 rounded-none hover:opacity-90 transition-opacity',
        ...
        input: 'w-full border-b border-crm-border p-3 rounded-none focus:outline-none bg-transparent font-serif wizard-input-focus',
        title: 'text-xl font-serif italic text-crm-text'
      };
    case 'classic':
      return {
        cardActive: 'border bg-[#fdfbf7] rounded-sm',
        cardInactive: 'border border-[#e6d9c6] bg-crm-surface rounded-sm wizard-card-hover',
        ...
        input: 'w-full border border-[#e6d9c6] p-3 rounded-sm focus:outline-none bg-crm-surface wizard-input-focus',
    ...
    default:
      return {
        ...
        cardInactive: 'border-2 border-transparent bg-crm-bg hover:border-crm-border rounded-xl wizard-card-hover',
