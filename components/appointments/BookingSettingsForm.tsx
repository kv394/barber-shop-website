...
export default function BookingSettingsForm({ shopId }: { shopId: string }) {
  ...
  return (
    <div className="bg-botanical-surface border border-botanical-border rounded-xl p-6 space-y-5">
      ...
      <label className="flex items-center justify-between p-4 bg-botanical-surface rounded-lg cursor-pointer">
        <div>
          <p className="text-sm font-medium text-botanical-text">Enable Online Booking</p>
          <p className="text-xs text-botanical-muted">Allow clients to book through your public portal</p>
        </div>
      ...
      <label className="flex items-center justify-between p-4 bg-botanical-surface rounded-lg cursor-pointer">
        <div>
          <p className="text-sm font-medium text-botanical-text">Auto-Confirm Bookings</p>
          <p className="text-xs text-botanical-muted">Automatically confirm new bookings without manual approval</p>
        </div>
