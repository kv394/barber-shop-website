  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <button onClick={() => setShowForm(!showForm)} className="bg-botanical-primary text-botanical-bg font-bold px-4 py-2 rounded-lg text-sm hover:bg-white transition-colors">
      ...
      {showForm && (
        <div className="bg-botanical-surface p-6 rounded-lg border border-botanical-border space-y-4">
          ...
          <button onClick={handleCreate} disabled={creating || !amount} className="bg-botanical-primary text-botanical-bg font-bold px-6 py-2 rounded-lg text-sm hover:bg-white transition-colors disabled:opacity-50">
