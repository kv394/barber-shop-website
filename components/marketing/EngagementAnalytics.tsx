...
export default function EngagementAnalytics({ shopId }: { shopId: string }) {
  ...
  if (loading) return <p className="text-crm-muted text-center py-12 text-base md:text-lg">Loading analytics...</p>;
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-crm-surface backdrop-blur-xl shadow-2xl rounded-2xl border border-crm-border shadow-sm grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 relative z-20 overflow-hidden transform sm:-translate-y-6 sm:-mx-2 mb-2 sm:mb-6">
        <div className="p-4 sm:p-5 relative overflow-hidden group hover:bg-gray-50 transition-all duration-300 min-w-0 border-b lg:border-b-0 lg:border-r border-crm-border border-r md:border-r-0 flex flex-col items-center justify-center text-center">
          ...
          <h3 className="text-crm-muted uppercase tracking-widest font-semibold leading-tight mb-1 w-full truncate text-xs">Total Clients</h3>
          <p className="font-black text-crm-text break-words leading-tight w-full text-3xl md:text-4xl">{overview.totalClients}</p>
        </div>
        <div className="p-4 sm:p-5 relative overflow-hidden group hover:bg-gray-50 transition-all duration-300 min-w-0 border-b lg:border-b-0 lg:border-r border-crm-border md:border-r flex flex-col items-center justify-center text-center">
          ...
          <h3 className="text-crm-muted uppercase tracking-widest font-semibold leading-tight mb-1 w-full truncate text-xs">Active (30d)</h3>
          <p className="font-black text-crm-text break-words leading-tight w-full text-3xl md:text-4xl">{overview.activeLastMonth}</p>
        </div>
        <div className="p-4 sm:p-5 relative overflow-hidden group hover:bg-gray-50 transition-all duration-300 min-w-0 border-b lg:border-b-0 lg:border-r border-crm-border border-r md:border-r-0 flex flex-col items-center justify-center text-center">
          ...
          <h3 className="text-crm-muted uppercase tracking-widest font-semibold leading-tight mb-1 w-full truncate text-xs">New (30d)</h3>
          <p className="font-black text-crm-text break-words leading-tight w-full text-3xl md:text-4xl">{overview.newLastMonth}</p>
        </div>
        <div className="p-4 sm:p-5 relative overflow-hidden group hover:bg-gray-50 transition-all duration-300 min-w-0 border-b md:border-b-0 lg:border-r border-crm-border md:border-r flex flex-col items-center justify-center text-center">
          ...
          <h3 className="text-crm-muted uppercase tracking-widest font-semibold leading-tight mb-1 w-full truncate text-xs">Retention</h3>
          <p className="font-black text-crm-text break-words leading-tight w-full text-3xl md:text-4xl">{overview.retentionRate}%</p>
        </div>
        <div className="p-4 sm:p-5 relative overflow-hidden group hover:bg-gray-50 transition-all duration-300 min-w-0 border-r border-crm-border flex flex-col items-center justify-center text-center">
          ...
          <h3 className="text-crm-muted uppercase tracking-widest font-semibold leading-tight mb-1 w-full truncate text-xs">Appts (30d)</h3>
          <p className="font-black text-crm-text break-words leading-tight w-full text-3xl md:text-4xl">{overview.completedAppointments}</p>
        </div>
        <div className="p-4 sm:p-5 relative overflow-hidden group hover:bg-gray-50 transition-all duration-300 min-w-0 flex flex-col items-center justify-center text-center">
          ...
          <span className="text-status-pending text-xl sm:text-2xl mb-1 sm:mb-2 flex-shrink-0">⭐</span>
          <h3 className="text-crm-muted uppercase tracking-widest font-semibold leading-tight mb-1 w-full truncate text-xs">Avg Rating</h3>
          <p className="font-black text-crm-text break-words leading-tight w-full text-3xl md:text-4xl">{overview.averageRating}</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-crm-surface p-5 rounded-xl border border-crm-border shadow-sm">
          <h4 className="font-bold text-crm-text flex items-center gap-2 mb-3 text-xl md:text-2xl">
        ...
        {!topClients || topClients.length === 0 ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="text-crm-muted text-sm uppercase tracking-wider border-b border-crm-border">
                ...
                {topClients.map((c: any, idx: number) => (
                  <tr key={c.id} className="border-b border-crm-border hover:bg-crm-surface">
                    ...
                    <td className="py-2 px-2">
                      <p className="text-crm-text font-medium truncate max-w-[200px] text-base md:text-lg">{c.name || 'Guest'}</p>
                      <p className="text-crm-muted truncate text-base md:text-lg">{c.email}</p>
                    </td>
