...
export default function CampaignBuilder({ shopId }: { shopId: string }) {
 ...
 className="bg-crm-primary text-white px-4 py-2 rounded-lg text-[13px] font-bold hover:bg-status-pending"
 >
 ...
 ${i === 0 ? 'bg-blue-100 text-blue-700' : i === 1 ? 'bg-gray-100 text-crm-muted' : 'bg-orange-100 text-orange-700'}`}>
 ...
 className="bg-crm-primary text-white px-6 py-2 rounded-lg text-[13px] font-bold hover:bg-status-pending"
 >
 Create Campaign
 </button>
 </div>
 ...
 className="bg-status-confirmed text-crm-text px-4 py-2 rounded-lg text-[11px] font-bold hover:bg-status-confirmed disabled:opacity-50 shrink-0"
 >
