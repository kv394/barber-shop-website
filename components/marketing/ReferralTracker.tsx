    ...
    <div className="space-y-8">
      ...
      <div className="bg-botanical-surface p-6 rounded-xl border-2 border-b-[6px] border-botanical-border">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="bg-botanical-surface p-4 rounded-lg border-2 border-b-[6px] border-botanical-border text-center">
        ...
        {!referrals || referrals.length === 0 ? (
          ...
          <div className="space-y-2 max-h-[400px] overflow-y-auto">
            {referrals.map((ref: any) => (
              <div key={ref.id} className="flex items-center gap-3 bg-botanical-surface p-3 rounded-lg border-2 border-b-[6px] border-botanical-border">
