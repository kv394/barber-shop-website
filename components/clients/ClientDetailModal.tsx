...
export default function ClientDetailModal({ shopId, clientId, clientName, onClose, currency }: ClientDetailProps): React.ReactNode {
 ...
 className="w-full bg-crm-surface border border-crm-border shadow-sm rounded-lg p-2 text-[13px] text-crm-text placeholder-gray-600 focus:outline-none focus:border-brand-gold resize-y"
 rows={3}
 />
 </div>
 <div>
 ...
 className="w-full bg-crm-surface border border-crm-border shadow-sm rounded-lg p-2 text-[13px] text-crm-text placeholder-gray-600 focus:outline-none focus:border-brand-gold"
 />
 </div>
 <div>
 ...
 <div className="space-y-3">
 <textarea value={newFormula} onChange={e => setNewFormula(e.target.value)} placeholder="e.g. 2oz 5N + 1oz 6G + 20vol" className="w-full bg-crm-surface border border-crm-border shadow-sm rounded-lg p-2 text-[13px] text-crm-text focus:border-brand-gold resize-y" rows={2} required />
 <input type="text" value={newNotes} onChange={e => setNewNotes(e.target.value)} placeholder="Additional notes..." className="w-full bg-crm-surface border border-crm-border shadow-sm rounded-lg p-2 text-[13px] text-crm-text focus:border-brand-gold" />
