...
export default function DepositSettings({
  ...
  return (
    <div className="bg-botanical-surface p-6 rounded-lg border border-botanical-border mb-6">
        ...
        {depositRequired && (
          <div>
            ...
            <input
              ...
              className="w-48 bg-botanical-surface border border-botanical-border rounded p-2 text-botanical-text text-sm focus:outline-none focus:border-brand-gold"
            />
          </div>
        )}

        <div className="flex items-center gap-3">
          <button onClick={handleSave} disabled={saving} className="bg-botanical-primary text-botanical-bg font-semibold px-6 py-2 rounded hover:bg-white transition-colors disabled:opacity-50 text-sm">
