                ...
                {matchedProduct ? (
                  <div>
                    <div className="bg-white/5 p-4 rounded-lg mb-4 border border-white/10">
                      <h4 className="font-semibold text-white">{matchedProduct.name}</h4>
                      <p className="text-gray-400 text-sm mt-1">Stock: <span className="font-mono text-white text-lg ml-1">{matchedProduct.inventoryCount}</span></p>
                    </div>
                  ...
                  <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                    ...
                    <p className="text-xs text-gray-400 mb-4">Map this barcode to a product:</p>
