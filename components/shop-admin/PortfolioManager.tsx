  ...
  return (
    <div className="bg-botanical-surface border-2 border-b-[6px] border-botanical-border rounded-xl p-6">
      ...
      {(userRole === 'SHOP_ADMIN' || userRole === 'SUPER_ADMIN') && staffList.length > 0 && (
        <div className="mb-6 p-4 bg-botanical-surface rounded-lg border-2 border-b-[6px] border-botanical-border">
      ...
      <form onSubmit={addImage} className="mb-8 p-4 bg-botanical-bg/50 rounded-lg border-2 border-b-[6px] border-botanical-border space-y-4">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
          {images.map(img => (
            <div key={img.id} className="relative group rounded-lg overflow-hidden border-2 border-b-[6px] border-botanical-border aspect-square bg-botanical-surface">
