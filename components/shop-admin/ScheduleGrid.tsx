            ...
            <div className="flex flex-wrap justify-between gap-x-2 gap-y-2 items-start mb-3 mt-1">
              ...
              <div className="flex flex-col gap-1 items-end shrink-0">
                {staffMember.using === 'default' && (
                  <span className="text-[10px] bg-amber-900/50 text-amber-300 px-2 py-0.5 rounded-md border border-amber-800/50 uppercase tracking-wider font-bold">
                    Default
                  </span>
                )}
                {staffMember.using === 'shop' && (
                  <span className="text-[10px] bg-status-info/20 text-status-info px-2 py-0.5 rounded-md border border-status-info/20 uppercase tracking-wider font-bold">
                    Shop
                  </span>
                )}
              </div>
