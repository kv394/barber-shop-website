...
export default function SecondarySidebar({ shopId, userRole }: { shopId: string, userRole: string }) {
  ...
  return (
    <aside className="hidden md:flex flex-col w-56 bg-crm-surface border-r border-crm-border flex-shrink-0 z-10">
      <div className="h-16 flex items-center px-4 border-b border-crm-border">
