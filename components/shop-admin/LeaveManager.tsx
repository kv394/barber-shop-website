          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <input 
                ...
                className="w-full bg-botanical-surface border-2 border-b-[6px] border-botanical-border rounded-lg px-3 py-2 text-botanical-text focus:border-brand-gold outline-none"
              />
            </div>
            <div>
