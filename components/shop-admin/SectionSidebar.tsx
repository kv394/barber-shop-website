  ...
  return (
    <div className="relative">
      <nav 
        ...
        className="flex flex-row md:flex-col gap-1 md:gap-0 overflow-x-auto scrollbar-none pb-1 md:pb-0 pl-4 md:pl-0 pr-8 md:pr-0 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] md:bg-transparent"
      >
        {navLinks.map((l) => {
          ...
          return (
            <Link
              ...
              className={`px-3 md:px-4 py-2 md:py-4 rounded-xl md:rounded-none text-sm font-bold md:font-medium whitespace-nowrap transition-all duration-150 relative w-full text-left md:border-b md:border-crm-border md:last:border-b-0 ${
                isActive 
                  ? 'bg-crm-bg/80 md:bg-crm-primary/5 text-crm-text md:text-crm-primary shadow-sm md:shadow-none border border-crm-border md:border-transparent md:border-b-crm-border transform translate-y-0.5 md:transform-none' 
                  : 'bg-crm-surface md:bg-transparent text-crm-muted hover:bg-gray-50 md:hover:bg-black/5 md:hover:text-crm-text border border-crm-border md:border-transparent md:border-b-crm-border shadow-sm md:shadow-none'
              }`}
            >
              {isActive && (
                 <div className="hidden md:block absolute left-0 top-1/2 -translate-y-1/2 w-1 h-3/5 bg-crm-primary rounded-r-full hover:opacity-90 text-white" />
              )}
              {l.label}
            </Link>
          );
      ...
      >
        <div className="w-6 h-6 bg-crm-surface shadow-sm border border-crm-border rounded-full flex items-center justify-center animate-pulse">
          <span className="text-crm-text font-black text-lg leading-none -mt-0.5 mr-0.5">‹</span>
        </div>
      </div>
      ...
      >
        <div className="w-6 h-6 bg-crm-surface shadow-sm border border-crm-border rounded-full flex items-center justify-center animate-pulse">
          <span className="text-crm-text font-black text-lg leading-none -mt-0.5 ml-0.5">›</span>
        </div>
      </div>
    </div>
  );
