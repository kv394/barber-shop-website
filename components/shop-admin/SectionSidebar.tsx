        ...
        {navLinks.map((l) => {
          ...
          return (
            <Link
              ...
              className={`px-5 md:px-5 py-2.5 md:py-4 rounded-xl md:rounded-none text-[10px] font-bold md:font-medium whitespace-nowrap transition-all duration-150 relative w-full text-left md:border-b md:border-botanical-border md:last:border-b-0 ${
                isActive 
