    ...
    <div className="bg-botanical-surface border border-botanical-border shadow-sm rounded-xl p-6">
      ...
      {forms.length === 0 ? (
        ...
        <div className="space-y-3">
          {forms.map(f => (
            <div key={f.id} className="p-4 bg-botanical-surface rounded-lg border border-botanical-border shadow-sm flex flex-wrap justify-between gap-x-2 gap-y-2 items-start gap-4">
              <div>
