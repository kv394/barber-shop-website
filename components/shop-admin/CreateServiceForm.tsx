...
export default function CreateServiceForm({ shopId }: { shopId: string }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="mt-8 pt-6 border-t border-white/10" noValidate>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <select 
          ...
          className="bg-black/40 border border-white/20 rounded p-3 text-white focus:outline-none focus:ring-1 focus:ring-brand-gold md:col-span-2"
        >
        ...
        {!isInternal ? (
          ...
          <>
            ...
            <div className="md:col-span-2">
                ...
                className="w-full bg-black/40 border border-white/20 rounded p-3 text-white placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-brand-gold font-mono" 
                />
            </div>
             <div className="md:col-span-2">
              <input 
      ...
      {!isInternal && (
        <div className="flex items-center space-x-3 py-4 mt-4">
          <input type="checkbox" id="trackInventory" checked={trackInventory} onChange={(e) => setTrackInventory(e.target.checked)} className="w-4 h-4 accent-brand-gold bg-white/10 border-white/20 rounded focus:ring-brand-gold" />
      ...
      <button 
        ...
        className="w-full bg-brand-gold text-brand-dark font-semibold py-3 rounded-lg hover:bg-white transition-colors disabled:opacity-50 disabled:cursor-not-allowed mt-4"
      >
