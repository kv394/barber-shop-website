    ...
    <form onSubmit={handleSubmit} className="mt-8 pt-6 border-t border-botanical-border" noValidate>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <select 
          ...
          className="bg-botanical-surface border border-botanical-border rounded p-3 text-botanical-text focus:outline-none focus:ring-1 focus:ring-botanical-primary md:col-span-2"
        >
        ...
        <input 
          ...
          className="bg-botanical-surface border border-botanical-border rounded p-3 text-botanical-text placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-botanical-primary" 
        />
        ...
        {!isInternal ? (
          <>
            ...
            <div className="md:col-span-1">
              <input 
                ...
                className="w-full bg-botanical-surface border border-botanical-border rounded p-3 text-botanical-text placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-botanical-primary" 
              />
            </div>
            <div className="md:col-span-1">
              <input
          ...
          <>
            ...
            <div className="md:col-span-2">
                ...
                className="w-full bg-botanical-surface border border-botanical-border rounded p-3 text-botanical-text placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-botanical-primary font-mono" 
                />
            </div>
             <div className="md:col-span-2">
              <input 
      ...
      {!isInternal && (
        <div className="flex items-center space-x-3 py-4 mt-4">
          <input type="checkbox" id="trackInventory" checked={trackInventory} onChange={(e) => setTrackInventory(e.target.checked)} className="w-4 h-4 accent-brand-gold bg-botanical-border border-botanical-border rounded focus:ring-botanical-primary" />
