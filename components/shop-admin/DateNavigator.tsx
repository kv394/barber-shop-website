...
const DateNavigator: React.FC<DateNavigatorProps> = ({ defaultDate, onDateChange }) => {
 ...
 className="text-[11px] sm:text-[13px] text-crm-primary hover:text-crm-text bg-crm-primary/10 hover:bg-crm-primary/20 border border-crm-primary/20 transition-all duration-200 px-2 py-1 rounded-lg"
 >
 Today
 </button>
 )}
