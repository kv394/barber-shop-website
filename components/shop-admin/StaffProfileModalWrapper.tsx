    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-botanical-surface backdrop-blur-sm p-4" onClick={() => setIsOpen(false)}>
          <div className="bg-botanical-bg border border-botanical-border shadow-sm rounded-2xl p-6 w-full max-w-sm shadow-2xl relative" onClick={e => e.stopPropagation()}>
