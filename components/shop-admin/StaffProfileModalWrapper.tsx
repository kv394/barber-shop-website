        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4" onClick={() => setIsOpen(false)}>
          <div className="bg-botanical-bg border border-botanical-border rounded-2xl p-6 w-full max-w-sm shadow-2xl relative" onClick={e => e.stopPropagation()}>
            ...
            <div className="flex flex-col items-center pt-2">
              ...
              <div className="w-full space-y-4 text-sm bg-botanical-surface p-4 rounded-xl border border-white/5">
            ...
            <div className="mt-6">
              <button onClick={() => setIsOpen(false)} className="w-full py-3 bg-botanical-primary text-slate-900 rounded-xl hover:bg-yellow-400 transition-colors font-bold shadow-lg">
                Close Profile
              </button>
            </div>
          </div>
