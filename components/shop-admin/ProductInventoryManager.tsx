...
export default function ProductInventoryManager({ 
 ...
 return (
 <div className="flex items-center space-x-2 bg-crm-surface p-1 rounded-lg">
 ...
 className="w-16 bg-crm-bg border border-crm-border shadow-sm rounded-lg p-1 text-center text-crm-text focus:outline-none focus:ring-2 focus:ring-crm-primary"
 min="0"
 />
 ...
 onClick={handleAdd} 
 disabled={isUpdating}
 className="px-2 py-1 text-[11px] bg-crm-primary text-white hover:bg-crm-surface hover:text-crm-primary border border-transparent hover:border-crm-primary/30 rounded-lg font-semibold disabled:opacity-50"
 >
 Add
 </button>
 ...
 onClick={handleSet} 
 disabled={isUpdating}
 className="px-2 py-1 text-[11px] bg-purple-600 hover:bg-purple-500 text-crm-text rounded-lg font-semibold disabled:opacity-50"
 >
 Set
 </button>
 </div>
