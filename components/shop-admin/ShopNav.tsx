...
export function ShopNav({ shopId, userRole, activeTab }: { shopId: string, userRole: string, activeTab: string }) {
  ...
  const mainTabClass = (tabName: string, groupTabs?: string[]) => {
    ...
    return isActive
      ? "px-4 py-2 text-sm sm:text-base text-brand-dark bg-brand-gold whitespace-nowrap font-bold shadow-[0_4px_0_0_#b38b22,0_5px_10px_rgba(0,0,0,0.4)] transform -translate-y-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-gold rounded-lg transition-all"
