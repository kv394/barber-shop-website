  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-24 sm:bottom-8 right-4 sm:right-8 w-14 h-14 bg-brand-gold text-slate-900 rounded-full shadow-[0_0_20px_rgba(0,0,0,0.5)] flex items-center justify-center text-3xl hover:bg-yellow-400 hover:scale-105 active:scale-95 transition-all z-[90] relative"
        title="Team Chat"
      >
        💬
