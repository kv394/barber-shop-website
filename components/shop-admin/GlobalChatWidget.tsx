    ...
    <>
      ...
      >
        ...
        {unreadCount > 0 && !isOpen && (
          <span className="absolute -top-1 -right-1 bg-status-cancelled text-crm-text text-sm font-black w-6 h-6 flex items-center justify-center rounded-full border-2 border-white shadow-md animate-bounce">
        ...
        <div className="fixed bottom-0 sm:bottom-28 right-0 sm:right-8 w-full sm:w-[400px] h-[80dvh] sm:h-[600px] max-h-screen z-[100]">
          <div className="relative h-full w-full shadow-2xl">
            ...
            <button 
                ...
                className="absolute top-3 right-4 text-white hover:text-gray-200 z-10 w-8 h-8 bg-crm-surface/10 hover:bg-crm-surface/20 rounded-full flex items-center justify-center transition-colors"
            >
                ✕
            </button>
