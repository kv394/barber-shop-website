    ...
    <div className="space-y-6">
      ...
      <div className="bg-botanical-surface border-2 border-b-[6px] border-botanical-border rounded-xl p-6 space-y-4">
        ...
        <div className="flex gap-2">
          <input readOnly value={kioskUrl} className="flex-1 bg-botanical-surface border-2 border-b-[6px] border-botanical-border rounded-lg px-3 py-2.5 text-botanical-text text-sm font-mono focus:outline-none" />
      ...
      <div className="bg-botanical-surface border-2 border-b-[6px] border-botanical-border rounded-xl p-6 space-y-3">
        ...
        <a href={`/shop/${shopId}/settings/team`} className="inline-block px-4 py-2 bg-botanical-surface border-2 border-b-[6px] border-botanical-border text-botanical-muted rounded-lg text-sm hover:bg-botanical-border transition-colors">👥 Go to Team Management →</a>
      </div>
