        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={() => navigateDays(-1)}
              className="w-9 h-9 flex items-center justify-center rounded-xl bg-white border border-botanical-border shadow-sm hover:border-botanical-primary/40 text-slate-600 hover:text-slate-900 transition-all duration-200 text-sm font-bold">
              ←
            </button>
            <button onClick={() => navigateDays(1)}
              className="w-9 h-9 flex items-center justify-center rounded-xl bg-white border border-botanical-border shadow-sm hover:border-botanical-primary/40 text-slate-600 hover:text-slate-900 transition-all duration-200 text-sm font-bold">
        ...
        <div className={`grid grid-cols-1 ${showTimeFilters ? 'md:grid-cols-3' : 'md:grid-cols-1'} gap-3`}>
          <div>
            ...
            <input
              ...
              style={timeStyle}
              className="w-full p-2.5 rounded-lg border border-botanical-border shadow-sm text-slate-900 text-sm focus:ring-2 focus:ring-botanical-primary focus:outline-none transition-all"
            />
          </div>
          {showTimeFilters && (
            <>
