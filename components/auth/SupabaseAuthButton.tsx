...
export default function SupabaseAuthButton({ 
  ...
  if (loading) {
    return <div className="w-8 h-8 rounded-full bg-botanical-surface animate-pulse border border-botanical-border"></div>;
  }
  ...
  if (user) {
    const menuContent = (
      <>
        ...
        <div 
          className="fixed sm:absolute bottom-0 left-0 right-0 sm:bottom-auto sm:left-auto sm:right-0 sm:mt-2 w-full sm:w-72 bg-botanical-surface sm:border border-botanical-border rounded-t-3xl sm:rounded-xl shadow-2xl overflow-hidden pb-safe"
          style={{ zIndex: 99999 }}
        >
           <div className="p-6 sm:p-4 border-b border-botanical-border flex flex-col items-center bg-botanical-bg relative">
             ...
             <div className="bg-white p-3 sm:p-2 rounded-2xl shadow-inner inline-block border border-gray-200">
    ...
    return (
      <div className="relative inline-block z-50">
        <button 
          ...
          className="flex items-center gap-2 bg-botanical-surface hover:bg-botanical-bg border border-botanical-border px-3 py-1.5 rounded-full transition-colors shadow-sm"
        >
  ...
  return (
    <Link 
      ...
      className="bg-botanical-surface hover:bg-botanical-bg text-botanical-text px-4 py-2 rounded-lg text-sm font-semibold transition-colors shadow-sm border border-botanical-border"
    >
      Sign In
    </Link>
  );
